	...
	while (1) {
		...
		case 2: GiboCode = GiboDraw();
			...
			case 0:
				...
				scanf("%c", &savewhere);
				push_Gibo(replay_giboA, savewhere, whatturn, replay_giboA, replay_giboB, replay_giboC, replay_giboD);
				break;
			case 1:
				txtf_to_chessboard(replay_giboB, &whatturn);
				scanf("%c", &savewhere);
				push_Gibo(replay_giboB, savewhere, whatturn, replay_giboA, replay_giboB, replay_giboC, replay_giboD);
				break;
			case 2:
				txtf_to_chessboard(replay_giboC, &whatturn);
				scanf("%c", &savewhere);
				push_Gibo(replay_giboC, savewhere, whatturn, replay_giboA, replay_giboB, replay_giboC, replay_giboD);
				break;
			case 3:
				txtf_to_chessboard(replay_giboD, &whatturn);
				scanf("%c", &savewhere);
				push_Gibo(replay_giboD, savewhere, whatturn, replay_giboA, replay_giboB, replay_giboC, replay_giboD);
			}
